...
class ClientRepositoryImpl implements ClientRepository{
  ...
  @override
  Future<Either<Failure, ClientEntity>> createClient(CreateClientParams params)async {
  ...
  @override
  Future<Either<Failure, bool>> createClientContact(ClientContactParams params) async{
    final bool isConnected = await networkInfo.isConnected;
    if (isConnected) {
      try {
  ...
  @override
  Future<Either<Failure, ClientEntity>> editClient(CreateClientParams params) async{
    final bool isConnected = await networkInfo.isConnected;
    if (isConnected) {
      try {
  ...
  @override
  Future<Either<Failure, bool>> editClientContact(ClientContactParams params) async{
    final bool isConnected = await networkInfo.isConnected;
    if (isConnected) {
      try {
