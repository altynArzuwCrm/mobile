...
abstract class AssignmentDataSources {
  ...
  Future<AssignModel> getOrderAssignmentById(int id);
...
class AssignmentDataSourcesImpl extends AssignmentDataSources {
  ...
  @override
  Future<AssignModel> getOrderAssignmentById(int id) async {
    final response = await apiProvider.get(
      endPoint: '${ApiEndpoints.assignments}/$id',
    );
    final result = response.data;
    return AssignModel.fromJson(result);
  }
